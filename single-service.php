...
?>
<!-- BLOG SECTION  -->
<section id="blog" class="blog_posts single_page min-h-[100vh] my-4 font-poppins  px-4">
  <?php if (have_posts()): ?>
      ...
      <div <?php post_class('single_blog bg-white shadow-sm mb-4 rounded-lg'); ?>>
        ...
        <div class="blog_content px-4 py-3">
          ...
          <div class="author_info flex items-center">
            <h4 class="author_name text-slate-500 hover:text-slate-700 my-3 mr-2 text-xs font-bold">
          ...
          <div class="single_content text-slate-800 mb-2 overflow-hidden leading-6">
            <?php the_content(); ?>
          </div>
        </div>
      </div>
