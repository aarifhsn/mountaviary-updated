...
<body <?php body_class('font-poppins w-full mx-auto transition-all scroll-smooth'); ?>>
  ...
  <header class="bg-white  lg:hidden fixed top-0 left-0 min-h-[60px] z-50 w-full flex items-center">
  ...
  <div class="mount_body">
    <div class="container px-3 md:px-4 xl:p-0 mx-auto relative">
      <div class="site_content w-full relative">
        <div
          class="left_nav_content hidden lg:block 2xl:block flex-auto h-full z-50 top-0 left-0 fixed border-r-2 w-1/5 bg-left_nav-bg  bg-cover bg-no-repeat bg-center bg-white bg-opacity-80 backdrop-filter backdrop-blur-sm pl-16 pr-4">
          <div class="site_title flex font-poppins pt-16">
            ...
            <div class="site_context">
              <?php if (display_header_text()): // If user chooses to display header text. ?>
                <h1 class="site-title text-2xl"><a href="<?php echo esc_url(home_url('/')); ?>" class="font-bold"
                    rel="home"><?php echo get_bloginfo('name'); ?></a></h1>
          ...
          <div class="sidebar_area max-h-96 mb-20 mt-12">
            <div id="sidebar1" class="left_nav_info sidebar_toggle">
              <div class=" pr-4 pt-4 pb-4">
                <div class="left_nav text-left uppercase font-poppins font-bold text-sm text-slate-700 mt-4 relative">
                  <!-- LEFT NAV MENU -->
            ...
            <div class="front_page_social w-full mt-14">
              <ul class="social-icons flex flex-wrap gap-x-2 gap-y-6 justify-start text-lg text-slate-600">
                <?php
                ...
                foreach ($social_platforms as $platform => $icon_class) {
                  ...
                  if ($platform !== 'email') {
                    if ($url) {
                      echo "<li class='my-2'><a class='px-2 md:px-3 py-1 md:py-1.5 rounded border border-slate-200 hover:border-slate-400 border-solid' href='" . esc_url($url) . "' target='_blank'><i class='$icon_class w-4 h-4'></i></a></li>";
                    }
                  } else {
                    if ($url) {
