...
function mountaviary_customizer_register($wp_customize)
{
    ...
    $wp_customize->add_setting(
        'mountaviary_about_username_text',
        array(
            'default' => 'I\'m Arif',
            'sanitize_callback' => 'sanitize_text_field',
        )
    ...
    $wp_customize->add_setting(
        'mountaviary_about_user_designation',
        array(
    ...
    $wp_customize->add_setting(
        'mountaviary_about_user_content',
        array(
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'section' => 'mountaviary_portfolio_front_page_area',
            'description' => 'Get the id of the page from dashboard where you want to display all items.',
            'type' => 'number'
        )
    );
    ...
    // USER CONTACT INFO 
    $wp_customize->add_setting(
        'mountaviary_front_contact_page_phone',
        array(
            'sanitize_callback' => 'sanitize_text_field',
        )
    );
    ...
    $wp_customize->add_setting(
        'mountaviary_front_contact_page_email',
        array(
    ...
    $wp_customize->add_setting(
        'mountaviary_front_contact_page_location_text',
        array(
            'sanitize_callback' => 'sanitize_text_field',
        )
    );
...
function dark_logo_customizer($wp_customize)
{
    ...
    $wp_customize->add_control(new WP_Customize_Media_Control($wp_customize, 'dark_mode_logo', array(
        'label' => __('Dark Mode Logo', 'mountaviary'),
        'section' => 'title_tagline',
        'settings' => 'dark_mode_logo',
        'priority' => 9,
        'description' => __('Upload a logo optimized for dark mode.', 'mountaviary'),
    )));
}
add_action('customize_register', 'dark_logo_customizer');