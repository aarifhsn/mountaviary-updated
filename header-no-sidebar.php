      ...
      <div class="top_menu z-[15]">
        <div class="navbar  text-sm relative">
          <div class="screen_menu">
            <div class="left_nav capitalize font-poppins py-4 relative lg:block hidden">
              <!-- SCREEN MENU -->
  ...
  <div class="mount_body">
    <div class="container px-3 md:px-4 xl:p-0 mx-auto relative">
      <div class="site_content relative">
        <div class="body_content w-full overflow-hidden relative mt-10 md:mt-20">